...
function arrival_dynamic_styles(){
	...
	*
	*/
	$_after_top_hdr_top_padding = get_theme_mod('arrival_after_top_hdr_top_padding',$default[$prefix.'_after_top_hdr_top_padding']);
	$_after_top_hdr_btm_padding = get_theme_mod('arrival_after_top_hdr_btm_padding',$default[$prefix.'_after_top_hdr_btm_padding']);
	?>
